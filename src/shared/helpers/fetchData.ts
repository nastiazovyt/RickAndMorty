import {CharacterResponse, EpisodesResponse, LocationResponse} from "../types.ts";
...
export const fetchMultipleCharactersData = async (idArray: string[]): Promise<CharacterResponse> => {
