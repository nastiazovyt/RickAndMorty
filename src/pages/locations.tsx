        ...
        <div className="flex justify-center flex-col items-center mb-6">
            <div
                ...
                <div
                    ...
                    <span
                        className="text-green-800 font-bold absolute sm:block hidden -top-12 text-center -left-10 -rotate-12  bg-amber-200 p-2 rounded-2xl">turn on <br/>the sound</span>
